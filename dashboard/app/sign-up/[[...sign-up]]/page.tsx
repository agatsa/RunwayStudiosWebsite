  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-950 px-4">
      <div className="mb-6 text-center">
        ...
        <p className="mt-1 text-sm text-gray-400">Start your free analysis on Runway Studios</p>
      </div>
      <SignUp fallbackRedirectUrl="/dashboard" signInUrl="/sign-in" appearance={clerkDark} />
    </div>
  )
}
